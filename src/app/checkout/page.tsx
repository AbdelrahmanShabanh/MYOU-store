      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
              ...
              <div className="space-y-2">
                <label className="flex items-center border rounded-md px-4 py-3 cursor-pointer transition-all duration-150 focus-within:ring-2 focus-within:ring-pink-500">
                  ...
                  <span className="font-semibold">LE {shipping.toFixed(2)}</span>
                </label>
                <label className="flex items-center border rounded-md px-4 py-3 cursor-pointer transition-all duration-150 focus-within:ring-2 focus-within:ring-pink-500">
                  <input
                    type="radio"
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
              ...
              <div className="space-y-4">
                ...
                {paymentMethod === "card" && (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                    <input
                      ...
                      className="col-span-2 mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-pink-500 focus:ring-pink-500 dark:bg-gray-700 dark:text-white sm:text-sm"
                    />
                    <input
                      type="text"
                ...
                <label className="flex items-center cursor-pointer">
                  ...
                  />
                  <Image
                    src="/icons/da825f86efb52423c2785be6a2dd9124.jpg"
                    alt="Vodafone Cash"
                    width={32}
                    height={20}
                    className="ml-2 mr-2 h-5 w-8 object-contain"
                  />
            ...
            <button
              type="submit"
              className="w-full bg-pink-600 text-white py-3 px-4 rounded-full font-medium hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2 flex items-center justify-center space-x-2"
            >
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 lg:sticky lg:top-8">
            ...
            <form onSubmit={handleApplyCoupon} className="flex mb-4">
              ...
              <button
                type="submit"
                className="bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-white px-4 rounded-r-md font-medium hover:bg-pink-600 hover:text-white transition-colors"
              >
                Apply
              </button>
            </form>
            {appliedCoupon && (
              <div className="mb-2 text-green-600 dark:text-green-400 text-sm flex items-center">
